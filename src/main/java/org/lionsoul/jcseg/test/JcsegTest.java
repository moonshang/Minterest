...
//			}
	...
	public static void main(String[] args) throws JcsegException, IOException {
		...
		try
		{
			System.out.println(demo.segment(str));
		}
		catch(Exception e)
		{
			e.printStackTrace();
...
//			
//			
//			BufferedReader fileReader=new BufferedReader(new FileReader("D:\\TCLFiles\\WeiboNews\\corpus.txt"));
//			String line;
//			
//			OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("D:\\TCLFiles\\WeiboNews\\corpus_seg.txt"),"UTF-8"); 
//			while((line=fileReader.readLine())!=null)
//			{
//				System.out.println(line);
//				System.out.println(demo.segment(line.replace("<content>", "")));
//				out.write(demo.segment(line.replace("<content>", "")));
//				break;
//			}
//			out.flush();
//			out.close();
